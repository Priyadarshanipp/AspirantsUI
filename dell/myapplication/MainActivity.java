...
public class MainActivity extends AppCompatActivity
    ...
    public void gotoambulance(View view)
    {
        ...
        Intent i = new Intent(this, ambulancemain.class);
        startActivity(i);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_gallery) {
            ...
            Intent in=new Intent(this,ask_for_help.class);
            startActivity(in);

        } else if (id == R.id.nav_slideshow) {
            Intent in1=new Intent(this,About_us.class);
            startActivity(in1);

        } else if (id == R.id.nav_manage) {
            Intent in2=new Intent(this,add_hospital.class);
            startActivity(in2);
